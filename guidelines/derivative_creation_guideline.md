## AIニケちゃんファミリー 二次創作ガイドライン

本ガイドラインは、ニケ（以下「作者」）が創作したキャラクター「AIニケちゃん」「（キャラクターとしての）ニケ」「ミカゼ」「ぷにけ」「今日は何の日bot」（以下「本キャラクター」）に関する二次創作のルールを示すものです。二次創作活動に先立ち、本ガイドラインを必ずご確認ください。

なお、本ガイドラインは予告なく改定する場合があります。常に最新の版をご確認ください。

一般的な利用条件の正本は、公式サイトの[二次創作ガイドライン](https://nikechan.com/guidelines/derivative)です。本ファイルは、アセット利用時に確認しやすくするための複製です。
...
- 表記ルール: 配布・頒布する作品（デジタル/印刷物）およびその配布ページには、「非公式のファンメイド作品」である旨とキャラクター名の明記を必須とします（例文あり）。SNSの単発投稿など日常的な発信での明記は任意（推奨）です。
...
- 本リポジトリで配布しているAIニケちゃんのVRMファイル内のライセンス・利用条件に関するメタデータは、過去の設定であり適用されません。VRMの利用には、公式サイトの詳細版ガイドラインとVRMフォルダのREADMEに記載された現行条件を適用します。
...
- 収益機能の利用（条件付き可）: プラットフォーム標準の収益機能（例: 広告、クリエイターファンド、チップ/投げ銭、メンバーシップ）は、以下の条件を満たす限り利用可。スポンサー契約/タイアップ、アフィリエイト、物販・予約リンク等の外部商業導線は不可。
  ...
  - 申告基準:
    - 申告不要: 月間総収益が3万円以下、または当月に本キャラクターを主要に扱う投稿・配信がない場合。
    - 要申告: 月間総収益が3万円超で、当月に本キャラクターをタイトル/サムネイル等で主要に扱う投稿・配信が1件以上ある場合、または本キャラクターの登場がコンテンツの過半を占める投稿・配信がある場合。
    - 即時申告: 月間総収益が10万円超。
  - 迷う場合は事前にご相談ください。
...
- 表紙または奥付に「〇〇（キャラクター名）の非公式ファンメイド作品」等と明記。公式と誤認される装丁・ロゴ使用は禁止。
...
- 本項で配布を許可するのは、利用者が新規に制作した二次創作素材のみです。
- 作者が配布する公式アセット（VRM、ロゴ、音声、動画、台本、設定画等）は、原本・改変版ともに再配布できません。ゲーム、アプリ、素材集等へ公式アセットのデータそのものを同梱することも再配布に含みます。
- 利用者が新規に制作した二次創作素材の配布は可。
- 価格は無料のみ（任意支払い・投げ銭等も不可。第3.3に準拠）。
- 利用者が新規に制作した二次創作素材の改変・再配布は、「本ガイドラインと同一条件（非営利・表記必須・禁止事項順守）」を付したうえで可。
...
- 追加要件（AI特有）: 許可素材・許諾の取り扱い等はAI生成ガイドラインの定めに従ってください（例: 公式VRM、ロゴ、各キャラクターの公式三面図・設定画、個別提供されたボイスアセット以外の公式素材の不使用、他者二次創作の事前許諾 等）。

#### 3.6 公式ボイスアセット
- 本リポジトリの `/voice/` フォルダ内にある音声、動画、台本等は、試聴・閲覧・参考のために公開しているものであり、素材として利用できません。
- 転載、複製、切り出し、編集、改変、翻訳、朗読、作品への組み込み、公開、再配布、生成AIへの入力・参照・学習・変換等を禁止します。
- AIニケちゃんのボイスアセットを利用したい場合は、用途を記載して作者X（[@tegnike](https://x.com/tegnike)）へのDM、または[公式Discord](https://discord.com/invite/G4E5Sf3yj3)内で作者へのDMにより申請してください。作者から個別に提供されたアセットのみ、[ボイスアセット利用ガイドライン](../voice/VOICE_ASSET_GUIDELINE.md)を基本条件とし、提供時の個別通知で定めた範囲で利用できます。
- 個別通知で許可された範囲では、生成音声を動画、配信、ゲーム、アプリ、音声作品等の完成した二次創作へ組み込み公開できます。ただし、生成音声を再利用可能な音声素材集、音声API、学習用データセット、別の音声モデル等として配布・利用することはできません。
...
- 奥付向け例: 「本書は〇〇（キャラクター名）の二次創作（非公式）です。」

任意でクレジット（作者名/原著）を記載する場合の例（必須ではありません）

- 「クレジット: ニケ（@tegnike）／〇〇（キャラクター名）」
...
2. 配布・頒布する作品（デジタル/印刷物）およびその配布ページに、「〇〇（キャラクター名）の非公式ファンメイド作品」である旨を明記すること（SNSの単発投稿での明記は任意）。
3. 本ガイドラインの禁止事項に該当しないこと。
4. 利用者が新規に制作した二次創作素材の再配布・改変配布を行う場合、本ガイドラインと同一条件を付して共有すること。作者が配布する公式アセットの原本・改変版は再配布しないこと。
...
- Q: メンバー限定コンテンツは作れますか？
  - A: 本キャラクターを主要訴求にした独占公開や専用特典は不可です。チャンネル全体向けの一般特典内での軽微な登場は第3.1の条件に従い可です。
...
- Q: 作成した素材を配布/改変/再配布してもよいですか？
  - A: 利用者が新規に制作した二次創作素材であれば可能です。「本ガイドラインと同一条件（非営利・表記必須・禁止事項順守）」を付し、第三者素材のライセンスに従ってください（第3.4章）。作者が配布する公式アセットの原本・改変版は再配布できません。

- Q: 公式のVRM、ロゴ、音声、動画、台本、設定画をそのまま、または改変して再配布してもよいですか？
  - A: いいえ。原本・改変版ともに再配布できません。ゲームや素材集等へ公式アセットのデータそのものを同梱することもできません。レンダリングした画像・動画や、利用者が新規に制作した二次創作物の公開・配布は、各章の条件に従ってください。

- Q: `/voice/` フォルダの音声、動画、台本を作品に利用できますか？
  - A: いいえ。これらは試聴・閲覧・参考用であり、素材として利用できません。ボイスアセットを利用したい場合は、用途を記載して作者へX DMまたはDiscord DMで申請してください。個別に提供されたアセットのみ、ボイスアセット利用ガイドラインを基本条件とし、提供時の個別通知に従って利用できます。

- Q: 個別提供されたボイスで作った音声を作品に使えますか？
  - A: 提供時の個別通知で許可された範囲で、動画、配信、ゲーム、アプリ、音声作品等の完成した二次創作に組み込み公開できます。音声素材集、音声API、学習用データセット、別の音声モデル等としての配布・利用はできません。
