...
- 本リポジトリで配布しているVRMファイル内のライセンス・利用条件に関するメタデータは、過去の設定であり適用されません。VRMの利用には、本ガイドラインとVRMフォルダのREADMEに記載された現行条件を適用します。
...
- 作者が配布する公式アセット（VRM、ロゴ、音声、動画、台本等）は、原本・改変版ともに再配布できません。作品へ公式アセットのデータそのものを同梱することも再配布に含みます。
...
- AIニケちゃんのボイスアセットを利用したい場合は、用途を記載して作者X（[@tegnike](https://x.com/tegnike)）へDMで申請してください。作者から個別に提供されたアセットのみ、提供時の個別通知と[ボイスアセット利用ガイドライン](../voice/VOICE_ASSET_GUIDELINE.md)の範囲で利用できます。
...
- Q: 公式のVRM、ロゴ、音声、動画、台本をそのまま、または改変して再配布してもよいですか？
...
- Q: `/voice/` フォルダの音声、動画、台本を作品に利用できますか？
  - A: いいえ。これらは試聴・閲覧・参考用であり、素材として利用できません。ボイスアセットを利用したい場合は、用途を記載して作者X（@tegnike）へDMで申請してください。個別に提供されたアセットのみ、提供時の個別通知とボイスアセット利用ガイドラインに従って利用できます。
