...
- AIニケちゃんのボイスアセットを利用したい場合は、用途を記載して作者X（[@tegnike](https://x.com/tegnike)）へDMで申請してください。作者から個別に提供されたアセットのみ、提供時に案内する条件の範囲で利用できます。
...
- Q: `/voice/` フォルダの音声、動画、台本を作品に利用できますか？
  - A: いいえ。これらは試聴・閲覧・参考用であり、素材として利用できません。ボイスアセットを利用したい場合は、用途を記載して作者X（@tegnike）へDMで申請してください。個別に提供されたアセットのみ、提供時の条件に従って利用できます。
