...
### [VRMモデル・Blenderデータ (`/vrms/`)](vrms/README.md)
...
### [ボイス (`/voice/`)](voice/README.md)
- `sample.wav` - 試聴用サンプル（素材としては利用不可）
- `ohirome_music_video.mp4` - 閲覧用のお披露目MV（素材としては利用不可）
- `/scripts/` - 閲覧・参考用の収録台本（素材としては利用不可）
